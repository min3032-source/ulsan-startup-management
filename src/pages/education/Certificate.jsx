        ...
        >
          ...
          <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '8mm' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginTop: 'auto', paddingBottom: '12mm' }}>
              ...
              {/* 기관장 + 전자관인 */}
              <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', marginTop: '8px' }}>
                ...
                <div style={{ position: 'relative', marginLeft: '8px', width: '60px', height: '60px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ position: 'relative', zIndex: 2, fontSize: '18px', fontWeight: 'bold', color: '#1e3a6e' }}>(인)</span>
                  <img
                    src="/seal.png"
                    alt="전자관인"
                    style={{
